            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-2 mt-3'>
                <div className='flex flex-col'>
                    ...
                    <div className='flex flex-col md:flex-row border-2 border-slate-200 border-opacity-30 rounded-lg'>
                        <img src="" className='rounded-t-lg md:rounded-l-lg' alt="" />
                        <div className="p-4 flex flex-col">
                            ...
                            <div className='self-end flex justify-around items-center m-4 bg-secondary hover:bg-gradient-to-r from-primary to-accent p-3'>View details <span className='ml-2 mt-1'><FaArrowRight /></span></div>
                            <div className='divide-y divide-cyan-200'></div>
