...
const MainBanner = () => {
    return (
        <div className='flex flex-col items-center w-full p-4 md:p-20 md:w-4/5 mx-auto card mt-3'>
            <div>
                <h5 className='text-[#f5b7ea] text-lg'>Hey,there !! <span className='text-lg mr-2 text-white'>Myself</span></h5>
                <h2 className=' text-4xl font-bold text-white mt-2'>  Humaira Muntaha</h2>
